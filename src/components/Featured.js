  ...
  return (
    ...
    <div className="container-carousel">
      <Carousel>
        ...
        <img src="spider.webp"  className='img-slide-feat' alt="jejed"/>
        </div>
        <div className="slide">
        <div class="wrapInfoPost">
        <h3 class="titrePost">2022 FERRARI SF90 SPIDER</h3>
        ...
        <img src="gt.webp"  className='img-slide-feat' alt="jejed"/>
        </div>
        <div className="slide">
        <div class="wrapInfoPost">
        <h3 class="titrePost">2022 FERRARI SF90 SPIDER</h3>
        ...
        <img src="superfast.webp"  className='img-slide-feat' alt="jejed"/>
        </div>
        <div className="slide">
        <div class="wrapInfoPost">
        <h3 class="titrePost">2022 FERRARI SF90 SPIDER</h3>
