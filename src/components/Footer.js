    ...
    <div className='cfooter'>
      <div className='leftfooter'>
        <div className='containbar'>
          <span className='bartesti'></span><p>NEWSLETTER</p>
        </div>
      ...
      <section>
        ...
        <div className='foot-links'>
          <p>Consign Your Vehicle</p>
          <p>Sell Your Vehicle</p>
        </div>
        <div className='foot-links'>
          <p>Service Centers</p>
          <p>Parts</p>
          <p>Warranties & Service Plans</p>
        </div>
        <div className='foot-links'>
          <p>All News</p>
          <p>Event Calendar</p>
        ...
        <div className='foot-links'>
          <p>Bacchelli & Villa Restoration</p>
          <p>Services</p>
          <p>Awards</p>
          <p>News</p>
          <p>Contact</p>
          <p>Ferrari Registry</p>
        </div>
        <div className='foot-links'>
          <p>Scuderia Corsa Racing</p>
          <p>Driving Series</p>
          <p>Event Calendar</p>
          <p>Our Drivers</p>
          <p>Our Partners</p>
      ...
      <section className='four-footer'>
        <span>COPYRIGHT © 2023 - FERRARI BEVERLY HILLS - ALL RIGHTS RESERVED</span><div className='underlinelink'><span>PRIVACY POLICY</span><span>TERMS & CONDITIONS</span><span>COOKIE POLICY</span></div>
      </section>
      </div>
  );
}
